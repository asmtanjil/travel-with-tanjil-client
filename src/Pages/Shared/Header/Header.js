...
const Header = () => {
  ...
  const navMenu = <>
    ...
    <li className='mx-2 font-semibold'><Link to='/blog'>Blog</Link></li>
    {
      user?.email ?
        <>
          <li className='mx-2 font-semibold'><Link to=''>My Review</Link></li>
          <li className='mx-2 font-semibold'><Link to=''>Add Services</Link></li>
  ...
  return (
    <div className="navbar bg-orange-100">
      <div className="navbar-start">
        ...
        <Link to='/' className="btn btn-ghost normal-case text-xl"> <img style={{ width: 30, height: 30 }} src={logo} alt="" /> <span className='mx-2'>Travel With Tanjil</span> </Link>
      </div>
